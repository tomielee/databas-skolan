...
INSERT INTO `about` VALUES (1,'Jennifer Lee','eshop1','Inga fler gruppmedlemmar'),(2,'Jennifer Lee','eshop2','Inga fler gruppmedlemmar'),(3,'Jennifer Lee','eshop3','Inga fler gruppmedlemmar');
...
INSERT INTO `inventory` VALUES (1,'boo1','B:01',10),(2,'boo2','B:02',20),(3,'boo3','B:02',30),(4,'boo4','B:03',40),(5,'cd1','C:01',50),(6,'merch1','M:01',200),(8,'42','42',42),(9,'13','13',20);
...
INSERT INTO `order` VALUES (1,1,'2019-03-29 11:01:50','2019-03-29 11:16:46','2019-03-29 11:01:57',NULL,'2019-03-29 11:16:46'),(2,2,'2019-03-29 11:02:01','2019-03-29 11:08:46',NULL,'2019-03-29 11:02:18','2019-03-29 11:08:46'),(3,3,'2019-03-29 11:04:50','2019-03-29 11:08:21','2019-03-29 11:05:02',NULL,'2019-03-29 11:08:21'),(4,3,'2019-03-29 11:05:04','2019-03-29 11:17:28','2019-03-29 11:05:14',NULL,'2019-03-29 11:17:28'),(5,3,'2019-03-29 11:09:47','2019-03-29 11:13:31',NULL,NULL,'2019-03-29 11:13:31'),(6,3,'2019-03-29 11:14:09','2019-03-29 11:14:12',NULL,NULL,NULL),(7,1,'2019-03-29 13:16:01','2019-03-29 13:17:54','2019-03-29 13:16:47',NULL,'2019-03-29 13:17:54'),(8,1,'2019-03-29 13:18:12','2019-03-29 13:18:20',NULL,'2019-03-29 13:18:20',NULL);
...
INSERT INTO `order_row` VALUES (1,1,'boo1',4),(2,1,'boo3',18),(3,2,'boo3',17),(4,2,'merch1',13),(5,2,'42',35),(6,3,'42',32),(7,4,'42',36),(8,5,'boo4',16),(9,6,'42',17),(10,7,'42',30),(11,7,'13',16),(12,8,'boo3',3);
...
INSERT INTO `pick_list` VALUES (1,1,'boo1',4),(2,1,'boo3',18),(3,2,'boo3',17),(4,2,'merch1',13),(5,2,'42',35),(6,3,'42',32),(7,4,'42',36),(8,5,'boo4',16),(9,6,'42',17),(10,7,'42',30),(11,7,'13',16),(12,8,'boo3',3);
...
CREATE TABLE `prod_2_cat` (
  ...
  KEY `cat_id` (`cat_id`),
  KEY `prod_id` (`prod_id`),
  CONSTRAINT `prod_2_cat_ibfk_1` FOREIGN KEY (`cat_id`) REFERENCES `prod_cat` (`id`),
  CONSTRAINT `prod_2_cat_ibfk_2` FOREIGN KEY (`prod_id`) REFERENCES `product` (`id`)
...
INSERT INTO `prod_2_cat` VALUES (1,'boo1','cat_book'),(2,'boo2','cat_book'),(3,'boo2','cat_new'),(4,'boo3','cat_book'),(5,'boo3','cat_sale_50'),(6,'boo4','cat_book'),(7,'boo4','cat_book'),(8,'boo4','cat_sale_spring_19'),(9,'cd1','cat_cd'),(10,'cd1','cat_new'),(11,'merch1','cat_merch'),(12,'merch1','cat_sale_25'),(16,'42','cat_new'),(17,'13','cat_new'),(18,'13','cat_book'),(19,'13','cat_sale_50');
...
INSERT INTO `prod_cat` VALUES ('cat_book','Book'),('cat_cd','CD'),('cat_merch','Merch'),('cat_new','New'),('cat_sale_25','Sale 25%'),('cat_sale_50','Sale 50%'),('cat_sale_spring_19','Sale Spring 2019');
...
INSERT INTO `product` VALUES ('13','13','13',13),('42','42','42',42),('boo1','Diktboken','Lite lyrik',20),('boo2','Romanboken','En skönlitterär bok',90),('boo3','Kokboken','En massa gott',100),('boo4','Barnboken','Hittepå och färgglatt',50),('cd1','CD','Great music',60),('merch1','Tygkasse','En bra kasse',25);
...
INSERT INTO `product_log` VALUES (1,'boo1','2019-03-29 10:00:30','trigger - insert','Diktboken','Lite lyrik',20),(2,'boo2','2019-03-29 10:00:30','trigger - insert','Romanboken','En skönlitterär bok',90),(3,'boo3','2019-03-29 10:00:30','trigger - insert','Kokboken','En massa gott',100),(4,'boo4','2019-03-29 10:00:30','trigger - insert','Barnboken','Hittepå och färgglatt',50),(5,'cd1','2019-03-29 10:00:30','trigger - insert','CD','Great music',60),(6,'merch1','2019-03-29 10:00:30','trigger - insert','Tygkasse','En bra kasse',25),(7,'42','2019-03-29 10:01:27','trigger - insert','42','42',42),(8,'13','2019-03-29 12:14:28','trigger - insert','13','13',13),(9,'13','2019-03-29 12:15:13','trigger - update','13','13',13),(10,'13','2019-03-29 12:15:13','trigger - update','13','13',13);
...
--
-- Temporary view structure for view `v_cat`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_cat` AS SELECT 
 1 AS `title`,
 1 AS `categories`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `v_prod_and_cat`
--

DROP TABLE IF EXISTS `v_prod_and_cat`;
/*!50001 DROP VIEW IF EXISTS `v_prod_and_cat`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_prod_and_cat` AS SELECT 
 1 AS `id`,
 1 AS `title`,
 1 AS `info`,
 1 AS `price`,
...
--
-- Temporary view structure for view `v_products_cat`
--

DROP TABLE IF EXISTS `v_products_cat`;
/*!50001 DROP VIEW IF EXISTS `v_products_cat`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_products_cat` AS SELECT 
 1 AS `id`,
 1 AS `title`,
 1 AS `info`,
 1 AS `price`,
...
--
-- Temporary view structure for view `v_show_prod`
--

DROP TABLE IF EXISTS `v_show_prod`;
/*!50001 DROP VIEW IF EXISTS `v_show_prod`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_show_prod` AS SELECT 
 1 AS `id`,
 1 AS `title`,
 1 AS `info`,
 1 AS `price`,
...
--
-- Temporary view structure for view `v_show_product`
--

DROP TABLE IF EXISTS `v_show_product`;
/*!50001 DROP VIEW IF EXISTS `v_show_product`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `v_show_product` AS SELECT 
 1 AS `id`,
 1 AS `title`,
 1 AS `info`,
 1 AS `price`,
...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE prod_id = a_id AND cat_id = a_cat) THEN
			INSERT INTO prod_2_cat (prod_id, cat_id)
                VALUES(a_id, a_cat);
	END IF;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `shoe_inventory_t` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `shoe_inventory_t`(
)
BEGIN
	SELECT 
		p.prodid AS prodid,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_cat_prod` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_cat_prod`(
	a_catid VARCHAR(10)
)
BEGIN
	SELECT
...
BEGIN
	...
	SELECT
        ...
        CONCAT(c.adress, " ", c.zip, ", ", c.city) AS adress,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `show_inventory_t` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_inventory_t`(
)
BEGIN
	SELECT 
		p.id AS prodid,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `show_log_search`(
	a_search VARCHAR(30)
)
MAIN: BEGIN
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_cat` AS select `p`.`title` AS `title`,group_concat(distinct `c`.`cat` order by `c`.`cat` ASC separator ', ') AS `categories` from ((`prod_2_cat` `p2` join `product` `p` on((`p2`.`prod_id` = `p`.`id`))) join `prod_cat` `c` on((`p2`.`cat_id` = `c`.`id`))) group by `p`.`title` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_order_info` AS select `o`.`id` AS `orderid`,`o`.`created` AS `ordercreated`,`o`.`customer_id` AS `customerid`,`vc`.`name` AS `customername`,`vc`.`adress` AS `adress`,`vc`.`telefon` AS `telefon`,`orow`.`prod_id` AS `prodid`,concat(substr(`p`.`info`,1,20),'...') AS `prodinfo`,`p`.`price` AS `price`,`orow`.`amount` AS `amount`,(`p`.`price` * `orow`.`amount`) AS `sum` from (((`order` `o` left join `order_row` `orow` on((`orow`.`order_id` = `o`.`id`))) left join `product` `p` on((`p`.`id` = `orow`.`prod_id`))) left join `v_customer` `vc` on((`vc`.`id` = `o`.`customer_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_prod_and_cat`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_prod_and_cat` AS select `p`.`id` AS `id`,`p`.`title` AS `title`,`p`.`info` AS `info`,`p`.`price` AS `price`,`p`.`items` AS `items`,`c`.`categories` AS `categories` from (`v_show_prod` `p` join `v_cat` `c` on((`p`.`title` = `c`.`title`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `v_products_cat`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_products_cat` AS select `prod`.`id` AS `id`,`prod`.`title` AS `title`,`prod`.`info` AS `info`,`prod`.`price` AS `price`,`inv`.`items` AS `items` from (`product` `prod` join `inventory` `inv` on((`prod`.`id` = `inv`.`prod_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_show_prod`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_show_prod` AS select `prod`.`id` AS `id`,`prod`.`title` AS `title`,`prod`.`info` AS `info`,`prod`.`price` AS `price`,`inv`.`items` AS `items` from (`product` `prod` join `inventory` `inv` on((`prod`.`id` = `inv`.`prod_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `v_show_product`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_show_product` AS select `prod`.`id` AS `id`,`prod`.`title` AS `title`,`prod`.`info` AS `info`,`prod`.`price` AS `price`,`inv`.`items` AS `items` from (`product` `prod` join `inventory` `inv` on((`prod`.`id` = `inv`.`prod_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2019-03-29 13:20:39
