...
DROP TABLE IF EXISTS plock_list; -- a rest from kmom05  //in case UX for kmom05

DROP TABLE IF EXISTS invoice_row;
DROP TABLE IF EXISTS invoice;

DROP TABLE IF EXISTS `order`;
DROP TABLE IF EXISTS prod_order; -- a rest from kmom05  //in case UX for kmom05
